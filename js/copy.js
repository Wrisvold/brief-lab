...
export const WALKTHROUGH = {
  ...
  intro: 'Eight stops for seven elements. The first stop is the task alone. The next six each add one element, in the order its effect is easiest to see. The last stop runs the finished brief a second time. Fill the Prediction box before each run if you can.',
